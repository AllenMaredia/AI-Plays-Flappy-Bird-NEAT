...
def draw_window(win, birds, pipes, base, score, gen, alive):
    ...
    for bird in birds:
        ...
        if bird.x <= pipes[0].x + pipes[0].PIPE_TOP.get_width():
            pygame.draw.line(win, (255,0,0), (bird.x + 25,bird.y + 25), (pipes[0].x, pipes[0].height), 4)
            pygame.draw.line(win, (255,0,0), (bird.x + 25,bird.y + 25), (pipes[0].x, pipes[0].height + pipes[0].GAP), 4)
        else:
            pygame.draw.line(win, (255,0,0), (bird.x + 25,bird.y + 25), (pipes[1].x, pipes[1].height), 4)
            pygame.draw.line(win, (255,0,0), (bird.x + 25,bird.y + 25), (pipes[1].x, pipes[1].height + pipes[1].GAP), 4)
